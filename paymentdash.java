...
public class paymentdash extends javax.swing.JFrame {
    ...
    for (int i = 0; i < jTable1.getRowCount(); i++) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Invalid entry at row " + (i + 1));
        }
    ...
    bill.append("Service\tQty\tCost\n");

    for (int i = 0; i < jTable1.getRowCount(); i++) {
        Object service = jTable1.getValueAt(i, 0);
        Object qty = jTable1.getValueAt(i, 1);
        Object cost = jTable1.getValueAt(i, 2);
    ...
    bill.append("\nTotal: ").append(jTextField2.getText());
